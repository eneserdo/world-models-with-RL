...
echo "### Training VAE ###"
python trainvae.py --logdir ${LOGDIR} --dataset_dir datasets/carracing --verbose
sleep 5

echo "### Training MDRNN ###"
python trainmdrnn.py --logdir ${LOGDIR} --dataset_dir datasets/carracing --include_reward 
sleep 5
...
xvfb-run -s "-screen 0 1400x900x24" python traincontroller.py --logdir ${LOGDIR} --n-samples 4 --pop-size 4 --target-return 950 --display